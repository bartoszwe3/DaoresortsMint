    ...
    <Section id="s10" className="py-20 md:py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6 mb-14 text-left">
                {[
                    { pct: 70, amount: "~13 993 PLN", label: t("prezentacja_s10_row1_label", "Budowa resortu"), desc: t("prezentacja_s10_row1_desc", "Materiały budowlane, robocizna, infrastruktura"), color: "bg-[#C9A84C]" },
                    { pct: 10, amount: "~1 999 PLN", label: t("prezentacja_s10_row2_label", "Fundusz remontowy wspólnoty"), desc: t("prezentacja_s10_row2_desc", "Twoje pieniądze na przyszłość resortu"), color: "bg-green-500" },
                    { pct: 20, amount: "~3 998 PLN", label: t("prezentacja_s10_row3_label", "Development i obsługa"), desc: t("prezentacja_s10_row3_desc", "Prawnik, marketing, wynagrodzenie foundera"), color: "bg-[#2D5A3D]" }
                ].map((item, i) => (
                    <div key={i}>
...
const S11 = ({ t }) => {
    ...
    const faqs = [
        { q: t("prezentacja_s11_q1", "„Skąd mam wiedzieć że to nie oszustwo?”"), a: t("prezentacja_s11_a1", "Rozumiemy sceptycyzm. Dlatego: spółka z KRS, działka w księdze wieczystej, 100% zwrot jeśli nie budujemy. Sprawdź numer KRS 0001188626 v rejestrze KRS online - to publiczna informacja.") },
        { q: t("prezentacja_s11_q2", "„Co jeśli spółka zbankrutuje?”"), a: t("prezentacja_s11_a2", "Karta Członkowska jest Twoja — zapisana w publicznym rejestrze cyfrowym. Spółka zarejestrowana w KRS (numer 0001188626), działka w księdze wieczystej, dane publiczne.") },
        { q: t("prezentacja_s11_q3", "„Nie znam się na nowoczesnych technologiach”"), a: t("prezentacja_s11_a3", "Płacisz zwykłym przelewem. Logujesz się emailem. Otrzymujesz Kartę Członkowską — prawny dokument potwierdzający Twoje miejsce w resorcie.") },
        { q: t("prezentacja_s11_q4", "„14 nocy to mało”"), a: t("prezentacja_s11_a4", "14 nocy × 6 osób = 84 osobodoby rocznie. Przy cenie hotelu 800 PLN/noc to 67 200 PLN wartości. Ty płacisz ~692 PLN za tydzień. To nie „mało” - to matematyka.") },
        { q: t("prezentacja_s11_q5", "„A co jeśli chcę sprzedać?”"), a: t("prezentacja_s11_a5", "Karta Członkowska jest zbywalna. Możesz sprzedać swoje miejsce innemu kupującemu w dowolnym momencie. 10% wartości trafia do funduszu wspólnoty.") }
    ];
    return (
