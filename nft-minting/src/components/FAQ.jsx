            ...
            items: [
                {
                    ...
                    a: t("faq_a_1_1", "To pierwszy krok do członkostwa. Opłata 2000 PLN to rezerwacja miejsca w klubie (wpisowe zwrotne). Całkowity koszt członkostwa (27 000 PLN) jest rozłożony na 5 etapów płatnych wraz z postępem prac budowlanych.")
                },
                {
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    a: t("faq_a_2_9", "Tak - domki są dostępne przez cały rok, in tym zimą. Ogrzewanie, klimatyzacja i jacuzzi działają niezależnie od sezonu.")
                }
            ]
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    a: t("faq_a_3_6", "Resort znajduje się w Silna, Lubuskie - okolica jeziora Pszczewskiego, szlaki rowerowe, lasy. Na terenie resortu planowane są rowery elektryczne do wypożyczenia. Szczegółowa mapa atrakcji w okolicy będzie dostępna w aplikacji.")
                }
            ]
        },
        {
