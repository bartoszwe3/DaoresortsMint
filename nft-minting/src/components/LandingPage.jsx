                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg md:text-xl text-[#8A9E8A] font-light leading-relaxed max-w-2xl mx-auto">
                            Nie płacisz 27 000 PLN z góry. Każda wpłata
                    ...
                    <div className="space-y-4">
                            ...
                            return (
                                <div key={stage.id}
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className={`font-medium text-sm ${isActive ? 'text-white font-bold' : 'text-white/90'}`}>
                                                {stage.label_pl}
                                            </p>
                        ...
                        <div className="border-t border-[#C9A84C]/50 mt-8 pt-6 flex justify-between items-center px-2">
                            ...
                            <span className="text-2xl md:text-3xl font-bold font-sans text-white tracking-tight">27 000 PLN</span>
                        </div>
                    </div>
